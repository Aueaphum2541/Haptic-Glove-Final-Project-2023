...
class Device:
    ...
    async def gather_input(self):
        ...
        last_flap_ticks = previous_ticks
        flap_delay_ms = 100
        while self.active:
            value = self.poten.potentiometer_pin.read_u16()wwwww
            if abs(value - self.previous_value) > 1000:
                ...
                if current_ticks - previous_ticks > 200:
                    ...
                    # Simulate a spacebar press
                        ...
                        last_flap_ticks = current_ticks

        # Clear the spacebar press after the delay has passed
            if time.ticks_ms() - last_flap_ticks > flap_delay_ms:

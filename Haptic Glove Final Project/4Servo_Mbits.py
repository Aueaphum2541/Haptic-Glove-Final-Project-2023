...
while True:
    ...
    set_servo_position(REG_ADD_SERVO_1, 0)
    set_servo_position(REG_ADD_SERVO_2, 0)
    set_servo_position(REG_ADD_SERVO_3, 0)
    set_servo_position(REG_ADD_SERVO_4, 0)
    time.sleep(1)
    set_servo_position(REG_ADD_SERVO_1, 360)
    set_servo_position(REG_ADD_SERVO_2, 90)
    set_servo_position(REG_ADD_SERVO_3, 180)
    set_servo_position(REG_ADD_SERVO_4, 270)
